...
public class FactoryMap {
    public static Map<String, ArrayList<S@@tring>> createMap(int option) {
        return switch (option) {
            case 1 -> new HashMap<String, ArrayList<String> >();
            case 2 -> new TreeMap<String, ArrayList<String>>();
            case 3 -> new LinkedHashMap<String, ArrayList<String>>();
